...
namespace ContactPicker 
{
	...
	public class CustomTopTableViewCell : UITableViewCell
	{
		...
		/// </summary>
		private const string cellPrefix 	= "To: ";
		//========================================================================================================================================
		...
		//========================================================================================================================================
		/// <summary>
		/// Initializes a new instance of the <see cref="ContactPicker.CustomTopTableViewCell"/> class. Inits our labels
		/// </summary>
	...
	public class TableViewSourceTop : UITableViewSource
	{
		...
		//========================================================================================================================================
		/// <summary>
		/// Initializes a new instance of the <see cref="ContactPicker.TableViewSourceTop"/> class. Inits our labels
		/// </summary>
