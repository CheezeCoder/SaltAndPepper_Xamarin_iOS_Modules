...
namespace ContactPicker 
{
	...
	public class TableViewSourceSelectableObjects : UITableViewSource
	{
		...
		public override UITableViewCell GetCell (UITableView tableView, Foundation.NSIndexPath indexPath)
		{
			...
			cell = cell ?? new UITableViewCell (UITableViewCellStyle.Subtitle, bottomCellIdentifier);

				
			cell.DetailTextLabel.AttributedText 	= repo.All ().ElementAt (indexPath.Row).PhoneNumber;
			cell.TextLabel.AttributedText 		= repo.All ().ElementAt (indexPath.Row).FullName;
		...
		public override void RowSelected (UITableView tableView, Foundation.NSIndexPath indexPath)
		{
			if (cellDidPress != null) {
				cellDidPress (repo.All().ElementAt(indexPath.Row).FullName.Value);
			}
