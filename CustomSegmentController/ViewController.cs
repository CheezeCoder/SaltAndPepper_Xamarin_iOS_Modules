...
namespace CustomSegmentController
{
	...
	public class ViewController : UIViewController
	{
		...
		/// <summary>
		/// As we are not using a navigation controller for this example we need a UINavigation bar
		/// if we want to include and show one for the UIViewController.
		/// </summary>
		private readonly UINavigationBar navBar;
		/// <summary>
		...
		/// the needed steps to build the UINavigationBar ( <see cref="CustomSegmentController.ViewController.AddViewControllerTitle"/> for more info )
		...
		{
			this.navBar.TintColor 				= UIColor.LightGray;
			this.navBar.Frame 					= new CoreGraphics.CGRect (0, UIApplication.SharedApplication.StatusBarFrame.Height , this.View.Bounds.Width, this.defaultNavigationBarHeight);
			this.segmentControllerBarYoffset 	= (float)UIApplication.SharedApplication.StatusBarFrame.Height + (float)this.navBar.Frame.Height;
		...
		//========================================================================================================================================
		/// <summary>
		/// Properly establishes the UINavigationItem needed to display the title and pushes it onto the UINavigationItem
		/// we have created in this class.
		/// </summary>
		private void AddViewControllerTitle()
		{
			this.navItem = new UINavigationItem ("Segment Controller");
			this.navBar.PushNavigationItem (this.navItem, true);
		}
